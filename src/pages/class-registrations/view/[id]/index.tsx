...
import { getClassRegistrationById } from 'apiSdk/class-registrations';
...
function ClassRegistrationViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Class Registration Detail View
          </Text>
          {hasAccess('class_registration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/class-registrations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
